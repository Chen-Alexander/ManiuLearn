...
import com.maniu.weblib.interfaces.DWebViewCallBack;
import com.maniu.weblib.interfaces.DefaultWebLifeCycleImpl;
import com.maniu.weblib.interfaces.WebLifeCycle;
...
public abstract class BaseWebviewFragment extends BaseFragment implements DWebViewCallBack {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        CommandDispatcher.getInstance().initAidlConnect(getContext(), new Action<Object>(){
            @Override
